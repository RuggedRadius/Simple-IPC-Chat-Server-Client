...
namespace AT2_4
{
    public class PipeClient
    {
        ...
        public bool Connect(string pipename)
        {
            ...
            handle = CreateFile(
                      PipeName,
                      0xC0000000, // GENERIC_READ | GENERIC_WRITE = 0x80000000 | 0x40000000     -- ORIGINAL: -- 0xC0000000
                      0,
                      IntPtr.Zero,
                      3, // OPEN_EXISTING = open an existing pipe
            ...
            if (handle.IsInvalid)
            {
                Console.WriteLine("ERROR: Handle is invalid");
                //MessageBox.Show("ERROR: Handle is invalid", "Error", MessageBoxButton.OK, MessageBoxImage.Error);
                return false;
            }
